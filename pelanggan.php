  ...
  <body>
    ...
    <div class="flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-200 px-14">
      ...
      <div class="w-full flex px-6 py-8">
            ...
            <a href="tambahpel.php" class="bg-sky-400 rounded-md px-3 py-2 text-black hover:text-white">tambah</a>
            </div>
      <div class=" px-10">
              ...
              <tbody class="">
                <tr class=" my-10">
                    ...
                    <td class=" text-center py-4">
                      <a href="ubahpel.php?id=<?= $data_pel['id'] ?>" class=" mr-2 px-3 py-2  bg-blue-500 text-center rounded-lg  text-white">Ubah</a>
                      <a href="hapuspel.php?id=<?= $data_pel['id'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class=" px-3 py-2 bg-red-500 text-center rounded-lg text-white">Hapus</a>
                    </td>
                </tr>
              </tbody>
            <?php
