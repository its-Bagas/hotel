       ...
       //cek apakah email sudah terdaftar atau belum
         ...
         if(empty($username)){
             ...
             if ($check) {
                ...
                if ($insert){
                      echo "<script>alert('Sukses menambahkan pelanggan');location.href='hotel.php';</script>";
                   } else {
                      echo "<script>alert('Gagal menambahkan pelanggan');location.href='hotel.php';</script>";
                   }
             }
